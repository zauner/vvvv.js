...
VVVV.init=function(b,a,g){function f(){var d=new VVVV.Core.Patch("");_(VVVV.Nodes).each(function(c){var e=new c(0,d);"development"==VVVV_ENV&&console.log("Registering "+e.nodename);VVVV.NodeLibrary[e.nodename.toLowerCase()]=c});"development"==VVVV_ENV&&console.log("done ...");VVVV.Patches=[];VVVV.MainLoops=[];$("script[language='VVVV']").each(function(){var d=new VVVV.Core.Patch($(this).attr("src"),function(){var d=new VVVV.Core.MainLoop(this);VVVV.MainLoops.push(d)});VVVV.Patches.push(d)});"function"===
...
VVVV.Core={Pin:function(b,a,g,f,e){this.direction=a;this.pinname=b;this.links=[];this.values=g.slice(0);this.node=f;this.changed=!0;this.active=!1;this.reset_on_disconnect=e||!1;this.getValue=function(d,c){if(!c||1==c)return this.values[d%this.values.length];for(var e=[],j=0;j<c;j++)e.push(this.values[(d*c+j)%this.values.length]);return e};this.setValue=function(d,c){this.values[d]=c;this.changed=!0;this.node.dirty=!0;_(this.links).each(function(e){e.toPin.values[d]=c;e.toPin.changed=!0;e.toPin.node.dirty=
...
!1;this.dirty=!0;(this.patch=g)&&(this.patch.nodeMap[b]=this);this.addDefault=function(f,e){this.defaultPinValues[f]=e};this.addInputPin=function(f,e,d,c){pin=new VVVV.Core.Pin(f,PinDirection.Input,e,this,c);this.inputPins[f]=pin;this.patch.pinMap[this.id+"_"+f]=pin;this.applyPinValuesFromXML(f);return pin};this.addOutputPin=function(f,e){pin=new VVVV.Core.Pin(f,PinDirection.Output,e,this);this.outputPins[f]=pin;return this.patch.pinMap[this.id+"_"+f]=pin};this.addInvisiblePin=function(f,e){pin=new VVVV.Core.Pin(f,
PinDirection.Configuration,e,this);this.invisiblePins[f]=pin;this.patch.pinMap[this.id+"_"+f]=pin;void 0!=this.defaultPinValues[f]&&(pin.values=this.defaultPinValues[f]);return pin};this.IOBoxType=function(){return(match=/^IOBox \((.*)\)/.exec(this.nodename))&&1<match.length?match[1]:""};this.IOBoxInputPin=function(){switch(this.IOBoxType()){case "Value Advanced":return this.inputPins["Y Input Value"];case "String":return this.inputPins["Input String"];case "Color":return this.inputPins["Color Input"]}};
this.IOBoxOutputPin=function(){switch(this.IOBoxType()){case "Value Advanced":return this.outputPins["Y Output Value"];case "String":return this.outputPins["Output String"];case "Color":return this.inputPins["Color Output"]}};this.IOBoxRows=function(){return this.invisiblePins.Rows?this.invisiblePins.Rows.getValue(0):1};this.isComment=function(){return this.isIOBox&&0==_(this.outputPins).size()&&1==this.invisiblePins.length};this.label=function(){if(this.isIOBox)return this.IOBoxInputPin().getValue(0);
