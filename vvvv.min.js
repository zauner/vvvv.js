...
Math.max(h.height,c.y+25)),$bounds.attr("width")&&(c.width=$bounds.attr("width"),c.height=$bounds.attr("height")));/^iobox/.test(c.nodename.toLowerCase())&&(c.isIOBox=!0);e||c.setup();$(this).find("pin").each(function(){var e=$(this).attr("pinname");values=c.inputPins[e]&&c.inputPins[e].reset_on_disconnect&&"||"==$(this).attr("values")?void 0:f($(this).attr("values"));void 0==c.defaultPinValues[e]&&void 0!=values&&0<values.length&&c.addDefault(e,values);if(void 0==c.outputPins[e])if(void 0!=c.inputPins[e]){if(void 0!=
values&&!c.inputPins[e].isConnected()){for(var k=0;k<values.length;k++)c.inputPins[e].values[k]!=values[k]&&c.inputPins[e].setValue(k,values[k]);c.inputPins[e].setSliceCount(values.length)}}else if(void 0!=c.invisiblePins[e]){if(void 0!=values){for(k=0;k<values.length;k++)c.invisiblePins[e].values[k]!=values[k]&&c.invisiblePins[e].setValue(k,values[k]);c.invisiblePins[e].setSliceCount(values.length)}}else 1==$(this).attr("visible")&&"Configuration"!=$(this).attr("pintype")?"Output"==$(this).attr("pintype")||
0<$(d).find("link[srcnodeid="+c.id+"]").filter("link[srcpinname='"+e.replace(/[\[\]]/,"")+"']").length?void 0==c.outputPins[e]&&c.addOutputPin(e,values):void 0==c.inputPins[e]&&void 0==c.invisiblePins[e]&&c.addInputPin(e,values):void 0==c.inputPins[e]&&void 0==c.invisiblePins[e]&&c.addInvisiblePin(e,values)});e||(c.initialize(),h.nodeList.push(c));"complete"==g&&(m[c.id]=c)});"complete"==g&&(_(j).each(function(c,d){void 0==m[d]&&("development"==VVVV_ENV&&console.log("removing node "+c.id),h.nodeList.splice(h.nodeList.indexOf(c),
1),delete h.nodeMap[c.id])}),j={},_(m).each(function(c,d){j[d]=c}));"complete"==g&&(k={});$(d).find('link[deleteme="pronto"]').each(function(){for(var c=!1,d=0;d<h.linkList.length;d++)h.linkList[d].fromPin.node.id==$(this).attr("srcnodeid")&&(h.linkList[d].fromPin.pinname==$(this).attr("srcpinname")&&h.linkList[d].toPin.node.id==$(this).attr("dstnodeid")&&h.linkList[d].toPin.pinname==$(this).attr("dstpinname"))&&(c=h.linkList[d]);"development"==VVVV_ENV&&console.log("removing "+c.fromPin.pinname+
" -> "+c.toPin.pinname);var d=c.fromPin,e=c.toPin;c.destroy();d.connectionChanged();e.connectionChanged();e.markPinAsChanged();e.reset_on_disconnect&&e.reset()});$(d).find('link[deleteme!="pronto"]').each(function(){var c=h.pinMap[$(this).attr("srcnodeid")+"_"+$(this).attr("srcpinname")],d=h.pinMap[$(this).attr("dstnodeid")+"_"+$(this).attr("dstpinname")];void 0==c&&h.nodeMap[$(this).attr("srcnodeid")]&&(c=h.nodeMap[$(this).attr("srcnodeid")].addOutputPin($(this).attr("srcpinname"),void 0));void 0==
d&&h.nodeMap[$(this).attr("dstnodeid")]&&(d=h.nodeMap[$(this).attr("dstnodeid")].addInputPin($(this).attr("dstpinname"),void 0));if(c&&d){for(var e=!1,j=0;j<h.linkList.length;j++)h.linkList[j].fromPin.node.id==c.node.id&&(h.linkList[j].fromPin.pinname==c.pinname&&h.linkList[j].toPin.node.id==d.node.id&&h.linkList[j].toPin.pinname==d.pinname)&&(e=h.linkList[j]);if(!e){e=new VVVV.Core.Link(c,d);c.connectionChanged();d.connectionChanged();h.linkList.push(e);for(j=0;j<c.values.length;j++)d.setValue(j,
...
function(){for(var h=this.getMaxInputSliceCount(),b=0;b<h;b++){var a=parseFloat(g.getValue(b)),p=parseFloat(f.getValue(b)),r=parseFloat(e.getValue(b)),u=parseFloat(d.getValue(b)),r=r-a,u=u-p;c.setValue(b,a+r/2);k.setValue(b,p+u/2);j.setValue(b,Math.sqrt(r*r+u*u));m.setValue(b,Math.atan2(u,r)/(2*Math.PI))}c.setSliceCount(h);k.setSliceCount(h);j.setSliceCount(h);m.setSliceCount(h)}};VVVV.Nodes.Points2Vector2d.prototype=new VVVV.Core.Node;
...
function(){for(var h=this.getMaxInputSliceCount(),b=0;b<h;b++){var a=parseFloat(g.getValue(b)),p=parseFloat(f.getValue(b)),r=parseFloat(e.getValue(b)),u=2*parseFloat(d.getValue(b)-0.25)*Math.PI,s=r/2*Math.sin(u),r=-r/2*Math.cos(u);c.setValue(b,a+s);k.setValue(b,p+r);j.setValue(b,a-s);m.setValue(b,p-r)}c.setSliceCount(h);k.setSliceCount(h);j.setSliceCount(h);m.setSliceCount(h)}};VVVV.Nodes.Vector2Points2d.prototype=new VVVV.Core.Node;VVVV.Nodes.Polar3d=function(b,a){this.constructor(b,"Polar (3d)",a);this.meta={authors:["Matthias Zauner"],original_authors:["VVVV Group"],credits:[],compatibility_issues:[]};this.auto_evaluate=!1;var g=this.addInputPin("X",[0],this),f=this.addInputPin("Y",[0],this),e=this.addInputPin("Z",[-1],this),d=this.addOutputPin("Pitch",[0],this),c=this.addOutputPin("Yaw",[0],this),k=this.addOutputPin("Length",[1],this);this.evaluate=function(){for(var j=this.getMaxInputSliceCount(),b=0;b<j;b++){var h=g.getValue(b),
a=f.getValue(b),n=e.getValue(b),p=Math.sqrt(h*h+a*a+n*n);c.setValue(b,Math.atan2(-h,-n)/(2*Math.PI));d.setValue(b,0==p?0:Math.acos(-a/p)/(2*Math.PI)-0.25);k.setValue(b,p)}c.setSliceCount(j);d.setSliceCount(j);k.setSliceCount(j)}};VVVV.Nodes.Polar3d.prototype=new VVVV.Core.Node;
...
2*(g.getValue(b)+0.25)*Math.PI,a=2*f.getValue(b)*Math.PI,n=e.getValue(b);k.setValue(b,-n*Math.cos(a)*Math.sin(h));d.setValue(b,-n*Math.sin(a)*Math.sin(h));c.setValue(b,-n*Math.cos(h))}d.setSliceCount(j);c.setSliceCount(j);k.setSliceCount(j)}};VVVV.Nodes.Cartesian3d.prototype=new VVVV.Core.Node;
...
this.getMaxInputSliceCount(),h=0;h<b;h++){var a=g.getValue(h),n=f.getValue(h),p=e.getValue(h),r=Math.sqrt(a*a+n*n+p*p);d.setValue(h,0==r?0:a/r);c.setValue(h,0==r?0:n/r);k.setValue(h,0==r?0:p/r);j.setValue(h,r)}d.setSliceCount(b);c.setSliceCount(b);k.setSliceCount(b);j.setSliceCount(b)}};VVVV.Nodes.Normalize3d.prototype=new VVVV.Core.Node;
...
[],q=(new Date).getTime(),n=(new Date).getTime();this.evaluate=function(){var b=this.getMaxInputSliceCount();q=(new Date).getTime()-n;for(var a=0;a<b;a++){var u=g.getValue(a%g.values.length),s=f.getValue(a%f.values.length),l=e.getValue(a%e.values.length),v=d.getValue(a%d.values.length),t=c.getValue(a%c.values.length);void 0==m[a]&&(m[a]=0);void 0==h[a]&&(h[a]=0);0>=s&&(0!=u&&isFinite(u))&&(dv=1/(1E3*u)*q,0<l&&(dv*=-1),m[a]+=dv,0>m[a]&&(h[a]-=Math.ceil(-m[a]),m[a]=1+m[a]),1<m[a]&&(h[a]+=Math.floor(m[a])));
n=(new Date).getTime();0<v&&(m[a]=0);0.5>s&&(k.setValue(a,(m[a]+t)%1),j.setValue(a,h[a]));m[a]%=1}k.setSliceCount(b);j.setSliceCount(b);m.splice(b);h.splice(b)}};VVVV.Nodes.LFO.prototype=new VVVV.Core.Node;
...
[0],this);this.addOutputPin("Acceleration Out",[0],this);var d=[],c=[],k=[],j=[],m=[];this.evaluate=function(){for(var b=this.getMaxInputSliceCount(),a=g.pinIsChanged()||f.pinIsChanged(),n=0;n<b;n++){void 0==d[n]&&(d[n]=(new Date).getTime());var p=(new Date).getTime()-d[n],r=parseFloat(g.getValue(n)),u=parseFloat(f.getValue(n));void 0==c[n]&&(c[n]=r);!isFinite(r)||!isFinite(u)?(c[n]=void 0,e.setValue(n,void 0)):(a&&(j[n]=void 0,m[n]=0<=r-c[n],k[n]=0<u?(r-c[n])/(1E3*u):0),m[n]==0<=r-c[n]&&(c[n]+=k[n]*
p),void 0!=j[n]&&0<=r-c[n]!=0<=j[n]&&(k[n]=0,c[n]=r),0!=j[n]&&e.setValue(n,c[n]),j[n]=r-c[n],d[n]=(new Date).getTime())}a&&e.getSliceCount()!=b&&(d.splice(b),c.splice(b),k.splice(b),j.splice(b),e.setSliceCount(b))}};VVVV.Nodes.LinearFilter.prototype=new VVVV.Core.Node;
...
f.getValue(a);h[a].gradient.startY=e.getValue(a);h[a].gradient.endX=d.getValue(a);h[a].gradient.endY=c.getValue(a);h[a].gradient.colors=[];h[a].gradient.colorPositions=[];for(var p=Math.max(k.values.length,j.values.length),r=0;r<p;r++)h[a].gradient.colors.push(k.getValue(r).split(",")),h[a].gradient.colorPositions.push(j.getValue(r));m.setValue(a,h[a])}m.setSliceCount(b)}};VVVV.Nodes.LinearGradientCanvas.prototype=new VVVV.Core.Node;
...
h=0;h<b;h++)void 0==k[h]&&(k[h]=new j),k[h].transform=f.getValue(h),k[h].startAngle=2*parseFloat(e.getValue(h))*Math.PI,k[h].endAngle=2*parseFloat(d.getValue(h))*Math.PI,k[h].renderState=g.isConnected()?g.getValue(h):defaultRenderState;for(h=0;h<k.length;h++)c.setValue(h,k[h]);c.setSliceCount(b)}};VVVV.Nodes.ArcCanvas.prototype=new VVVV.Core.Node;
...
a=0,l=0,v=0;v<b||0<q.getValue(0)&&(0<l||0<a%e.getSliceCount());v++)void 0==p[a]&&(p[a]=new r),0==l&&(p[a].renderState=f.isConnected()?f.getValue(a):defaultRenderState,p[a].transform=e.getValue(a)),p[a].x[l]=parseFloat(d.getValue(v)),p[a].y[l]=parseFloat(c.getValue(v)),p[a].c1x[l]=parseFloat(k.getValue(v)),p[a].c1y[l]=parseFloat(j.getValue(v)),p[a].c2x[l]=parseFloat(m.getValue(v)),p[a].c2y[l]=parseFloat(h.getValue(v)),l++,0<q.getValue(0)&&l>=q.getValue(a)&&(l<p[a].x.length&&g(p[a],l),a++,l=0);0>q.getValue(0)&&
l<p[a].x.length?(g(p[a],l),p.splice(1)):p.splice(a);for(b=0;b<p.length;b++)n.setValue(b,p[b]);n.setSliceCount(p.length)}};VVVV.Nodes.BezierCurveCanvas.prototype=new VVVV.Core.Node;
...
!0,q.setValue(a,t[a]),n.setValue(a,t[a]))}if(e.pinIsChanged())for(a=0;a<b;a++)0.5<e.getValue(a)?t[a].play():t[a].pause();if(j.pinIsChanged())for(a=0;a<b;a++)t[a%t.length].loaded&&0.5<=j.getValue(a)&&(t[a%t.length].currentTime=parseFloat(m.getValue(a)),0.5<e.getValue(a)&&t[a].play());for(a=0;a<b;a++){if(!t[a].paused){q.setValue(a,t[a]);n.setValue(a,t[a]);p.getValue(a)!=t[a].duration&&p.setValue(a,t[a].duration);r.setValue(a,t[a].currentTime);var w=parseFloat(k.getValue(a)),E=parseFloat(c.getValue(a));
t[a].currentTime<E&&(t[a].currentTime=E);if(t[a].currentTime>=t[a].duration||0<=w&&t[a].currentTime>=w)0.5<=d.getValue(a)?t[a].currentTime=E:t[a].pause()}if(t[a].videoWidth!=u.getValue(a)||t[a].videoHeight!=s.getValue(a))u.setValue(a,t[a].videoWidth),s.setValue(a,t[a].videoHeight);l.getValue(a)!=g[t[a].networkState]&&l.setValue(a,g[t[a].networkState]);v.getValue(a)!=f[t[a].readyState]&&v.setValue(a,f[t[a].readyState])}q.setSliceCount(b);n.setSliceCount(b)}};VVVV.Nodes.FileStreamCanvas.prototype=new VVVV.Core.Node;
...
this.addOutputPin("Body",[""],this),j=this.addOutputPin("Fail",[0],this),m=this.addOutputPin("Success",[0],this),h,q,n,p=!1;this.evaluate=function(){this.getMaxInputSliceCount();var a=g.pinIsChanged()||f.pinIsChanged()||e.pinIsChanged()||d.pinIsChanged()&&1==d.getValue(0);1==m.getValue(0)&&m.setValue(0,0);1==j.getValue(0)&&j.setValue(0,0);p&&(k.setValue(0,h),c.setValue(0,void 0),m.setValue(0,q),j.setValue(0,n),p=!1);a&&(void 0==g.getValue(0)?(k.setValue(0,""),c.setValue(0,"")):$.ajax({url:g.getValue(0),
...
parseFloat(this.inpxin.getValue(h)),n=parseFloat(this.inpyin.getValue(h)),p=0;p<c;p++){var r=d+k*(p/c)*e,u=q+Math.cos(r)*a,r=n+Math.sin(r)*b;this.xout.setValue(j,u);this.yout.setValue(j,r);j++}this.xout.setSliceCount(c*m);this.yout.setSliceCount(c*m)}};VVVV.Nodes.CircularSpread.prototype=new VVVV.Core.Node;
...
[0],this),m=this.addOutputPin("Found At Position",[0],this);this.evaluate=function(){var a=this.getMaxInputSliceCount();c.setSliceCount(a);var b=e.getValue(0);d.getValue(0);for(var n=0,p=0;p<a;p++){var r=g.getValue(p),u=1;if("MatchesAny"==b||"ContainsAny"==b)u=f.getSliceCount();for(var s=0,l=0;l<u;l++){var v=f.getValue(l+p),t=[];if("Matches"==b||"MatchesAny"==b)v==r&&t.push(-1);else for(var v=RegExp(v,"gi"),z;z=v.exec(r);)t.push(z.index);for(v=0;v<t.length;v++)k.setValue(n,p%g.getSliceCount()),j.setValue(n,
(p+l)%f.getSliceCount()),m.setValue(n,t[v]+1),n++,s++}c.setValue(p,s)}k.setSliceCount(n);j.setSliceCount(n);m.setSliceCount(n)}};VVVV.Nodes.SiftString.prototype=new VVVV.Core.Node;
...
this),j=this.addOutputPin("Former Index",[0],this),m={None:"",Space:" ",Comma:",",CommaPlusSpace:", ",Semicolon:";",Colon:":",Pipe:"|",UnixPath:"/",DosPath:"\\",Dash:"-",NewLineAutoDetection:"\n",Dot:".",UnderScore:"_",Minus:"-"},h={Single:"'",Double:'"'};this.evaluate=function(){for(var a=this.getMaxInputSliceCount(),b=0,p=0;p<a;p++){var r=g.getValue(p),u=m[f.getValue(p)],s=e.getValue(p),l=h[d.getValue(p)],v=c.getValue(p);""==u&&(u=s);""==u&&(u=void 0);r=r.split(u);u=r.length;l=RegExp("[^"+l+"]*",
"g");for(s=0;s<u;s++)1==v?k.setValue(b,r[s]):k.setValue(b,r[s].match(l).join("")),j.setValue(b,p),b++}k.setSliceCount(b);j.setSliceCount(b)}};VVVV.Nodes.SeparateString.prototype=new VVVV.Core.Node;
...
h=f.getValue(b),q=e.getValue(b),m=m==h||0==q&&m.toLowerCase()==h.toLowerCase()?1:0;d.setValue(b,m);c.setValue(b,1-m)}d.setSliceCount(a);c.setSliceCount(a)}};VVVV.Nodes.EQString.prototype=new VVVV.Core.Node;
...
[0],this),k=this.addOutputPin("Right Button",[0],this),j=0,m=0,h=0,q=0,n=0,p=0;$(document).mousemove(function(c){j=2*c.pageX/parseInt($("body").css("width"))-1;m=-(2*c.pageY/parseInt($("body").css("height"))-1)});$(document).bind("mousewheel",function(c){h+=c.originalEvent.wheelDelta/120});$(document).bind("DOMMouseScroll",function(c){h+=-c.originalEvent.detail/3});$(document).mousedown(function(c){switch(c.which){case 1:q=1;break;case 2:n=1;break;case 3:p=1}});$(document).mouseup(function(c){switch(c.which){case 1:q=
0;break;case 2:n=0;break;case 3:p=0}});this.evaluate=function(){g.getValue(0)!=j&&g.setValue(0,j);f.getValue(0)!=m&&f.setValue(0,m);e.getValue(0)!=h&&e.setValue(0,h);d.getValue(0)!=q&&d.setValue(0,q);c.getValue(0)!=n&&c.setValue(0,n);k.getValue(0)!=p&&k.setValue(0,p)}};VVVV.Nodes.MouseGlobal.prototype=new VVVV.Core.Node;
...
this.getMaxInputSliceCount():Math.max(this.xIn.getSliceCount(),this.yIn.getSliceCount(),this.zIn.getSliceCount()),e=0;e<a;e++){var d=this.inputPins["Transform In"].getValue(e),c=parseFloat(this.inputPins.X.getValue(e)),b=parseFloat(this.inputPins.Y.getValue(e)),j=parseFloat(this.inputPins.Z.getValue(e)),g=mat4.create();mat4.identity(g);mat4.rotate(g,2*b*Math.PI,[0,1,0]);mat4.rotate(g,2*c*Math.PI,[1,0,0]);mat4.rotate(g,2*j*Math.PI,[0,0,1]);void 0!=d&&mat4.multiply(d,g,g);this.trOut.setValue(e,g)}this.trOut.setSliceCount(a)}};
...
this.getMaxInputSliceCount():Math.max(this.xIn.getSliceCount(),this.yIn.getSliceCount(),this.zIn.getSliceCount()),e=0;e<a;e++){var d=parseFloat(this.xIn.getValue(e)),c=parseFloat(this.yIn.getValue(e)),b=parseFloat(this.zIn.getValue(e)),j=mat4.create();mat4.identity(j);mat4.translate(j,[d,c,b]);this.trIn.isConnected()&&(d=this.trIn.getValue(e),mat4.multiply(d,j,j));this.trOut.setValue(e,j)}this.trOut.setSliceCount(a)}};VVVV.Nodes.Translate.prototype=new VVVV.Core.Node;
...
this.getMaxInputSliceCount():Math.max(this.xIn.getSliceCount(),this.yIn.getSliceCount(),this.zIn.getSliceCount()),e=0;e<a;e++){var d=parseFloat(this.inputPins.X.getValue(e)),c=parseFloat(this.inputPins.Y.getValue(e)),b=parseFloat(this.inputPins.Z.getValue(e)),j=mat4.create();mat4.identity(j);mat4.scale(j,[d,c,b]);this.inputPins["Transform In"].isConnected()&&(d=this.inputPins["Transform In"].getValue(e),mat4.multiply(d,j,j));this.trOut.setValue(e,j)}this.trOut.setSliceCount(a)}};
...
["Float"],this),j=this.addOutputPin("Output",[0.5],this);this.evaluate=function(){for(var a=this.getMaxInputSliceCount(),b=0;b<a;b++){var q=parseFloat(g.getValue(b)),n=parseFloat(f.getValue(b)),p=parseFloat(e.getValue(b)),r=parseFloat(d.getValue(b)),u=parseFloat(c.getValue(b)),s=k.getValue(b),q=q-n,p=p-n;switch(s){case "Clamp":q=Math.max(0,Math.min(p,q));break;case "Wrap":q=(p+q%p)%p}j.setValue(b,q*((u-r)/p)+r)}j.setSliceCount(a)}};VVVV.Nodes.MapValue.prototype=new VVVV.Core.Node;
...
this.renderContexts[0];if(a&&0.5<=d.getValue(0)){for(var b=[],h=[],q=[],n=0;n<this.getMaxInputSliceCount();n++)b[n]=parseFloat(g.getValue(n)),h[n]=parseFloat(e.getValue(n)),q[n]=parseFloat(f.getValue(n));k=new VVVV.Types.VertexBuffer(a,b);k.setSubBuffer("TEXCOORD0",2,h);k.setSubBuffer("NORMAL",3,q);k.create();c.setValue(0,k)}}};VVVV.Nodes.VertexBufferJoin.prototype=new VVVV.Core.WebGlResourceNode;
...
[],q=[],n=0,p=0;p<j;p++)for(var r=0;r<b;r++)m.push(parseFloat(r)/(b-1)-0.5),m.push(0.5-parseFloat(p)/(j-1)),m.push(0),n++,h.push(0),h.push(0),h.push(1),q.push(parseFloat(r)/(b-1)),q.push(parseFloat(p)/(j-1));m=new VVVV.Types.VertexBuffer(a,m);m.setSubBuffer("TEXCOORD0",2,q);m.setSubBuffer("NORMAL",3,h);m.create();h=[];for(p=0;p<j-1;p++)for(r=0;r<b-1;r++)q=r+b*p,h.push(q),h.push(q+1),h.push(q+b+1),h.push(q+b+1),h.push(q+b),h.push(q);d=new VVVV.Types.Mesh(a,m,h);e.setValue(0,d)}}}};
...
[],this);this.setAsWebGlResourcePin(m);var h=null;this.evaluate=function(){if(this.renderContexts){var a=this.renderContexts[0];if(a){var b=parseInt(k.getValue(0)),p=parseInt(j.getValue(0)),r=parseFloat(g.getValue(0)),u=parseFloat(f.getValue(0)),s=parseFloat(e.getValue(0)),l=parseFloat(d.getValue(0)),v=[],t=[],z=[];v.push(0);v.push(s/2);v.push(0);t.push(0);t.push(1);t.push(0);z.push(0);z.push(0);v.push(0);v.push(-s/2);v.push(0);t.push(0);t.push(-1);t.push(0);z.push(0);z.push(0);for(var C=0;C<p+1;C++)for(var w=
...
VVVV.Nodes.GenericShader=function(b,a){this.constructor(b,"GenericShader (EX9.Effect)",a);this.meta={authors:["Matthias Zauner"],original_authors:["VVVV Group"],credits:[],compatibility_issues:[]};this.shaderFile="";var g=this.addInputPin("Render State",[],this,!0),f=this.addInputPin("Mesh",[],this,!0),e=this.addInputPin("Transform",[],this,!0),d=this.addInputPin("Technique",[""],this),c=this.addOutputPin("Layer",[],this);this.setAsWebGlResourcePin(c);var k=[],j=null,m,h=[],q=this;this.initialize=
function(){$.ajax({url:q.shaderFile.replace("%VVVV%",VVVV.Root),async:!1,success:function(a){m=a;j=new VVVV.Types.ShaderProgram;q.addUniformPins();q.setupShader();e.markPinAsChanged()},error:function(){console.log("ERROR: Could not load shader file "+q.shaderFile.replace("%VVVV%",VVVV.Root));VVVV.onNotImplemented("Could not load shader file "+q.shaderFile.replace("%VVVV%",VVVV.Root))}})};this.addUniformPins=function(){j.extractSemantics(m);q=this;_(j.uniformSpecs).each(function(a){if(!("VIEW"==a.semantic||
...
0;m<b;m++)k[m].mesh=f.getValue(0);for(a=0;a<h.length;a++){var q=h[a].pinname.replace(/ /g,"_");if(h[a].pinIsChanged()||c<b)for(m=0;m<b;m++)if("vec"==j.uniformSpecs[q].type){var l="COLOR"==j.uniformSpecs[q].semantic?_(h[a].getValue(m).split(",")).map(function(a){return parseFloat(a)}):h[a].getValue(m,h[a].dimensions);k[m].uniforms[q].value=new Float32Array(l)}else l=h[a].getValue(m),"sampler"==k[m].uniforms[q].uniformSpec.type&&void 0==l&&(l=VVVV.DefaultTexture),k[m].uniforms[q].value=l}if(g.pinIsChanged()||
...
f=this.addInputPin("Background Color",["0.0, 0.0, 0.0, 1.0"],this),e=this.addInputPin("Backbuffer Width",[0],this),d=this.addInputPin("Backbuffer Height",[0],this),c=this.addInputPin("View",[],this),k=this.addInputPin("Projection",[],this),j=this.addInvisiblePin("Windowed Depthbuffer Format",["NONE"],this),m=this.addOutputPin("Actual Backbuffer Width",[0],this),h=this.addOutputPin("Actual Backbuffer Height",[0],this),q=this.addOutputPin("EX9 Out",[],this);this.setAsWebGlResourcePin(q);var n=0,p=0,
r,u,s=this.ctxt=void 0,l,v,t;this.getContexts=function(){if(this.invisiblePins["Descriptive Name"]){var a=this.invisiblePins["Descriptive Name"].getValue(0),a=$(a).get(0),b;if(!a||"CANVAS"!=a.nodeName){b=parseInt(e.getValue(0));var h=parseInt(d.getValue(0));b=$('<canvas width="'+(0<b?b:512)+'" height="'+(0<h?h:512)+'" id="vvvv-js-generated-renderer-'+(new Date).getTime()+'" class="vvvv-js-generated-renderer"></canvas>');a||(a="body");$(a).append(b)}else b=$(a);if(b){var j=b;$(j).detach("mousemove");
