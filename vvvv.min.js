...
0.5<f.getValue(b)&&l[b].play());for(b=0;b<a;b++){if(!l[b].paused){r.setValue(b,l[b]);n.setValue(b,l[b]);q.getValue(b)!=l[b].duration&&q.setValue(b,l[b].duration);s.setValue(b,l[b].currentTime);var z=parseFloat(g.getValue(b)),F=parseFloat(c.getValue(b));l[b].currentTime<F&&(l[b].currentTime=F);if(l[b].currentTime>=l[b].duration||0<=z&&l[b].currentTime>=z)0.5<=d.getValue(b)?l[b].currentTime=F:l[b].pause()}if(l[b].videoWidth!=v.getValue(b)||l[b].videoHeight!=u.getValue(b))v.setValue(b,l[b].videoWidth),
