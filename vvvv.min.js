...
("Node"!=a.typeName||VVVV.PinTypes[r.typeName].primitive))||0<=e.indexOf(a.node)||a.node==r.node?!1:!0}).append("svg:rect").attr("class","vvvv-connection-highlight resettable").attr("width",4).attr("height",3).attr("fill","rgba(0,0,0,1)").attr("y",function(a){return a.direction==PinDirection.Input?-3:3})}else{if(r.direction==PinDirection.Input)var f=a,g=r;else f=r,g=a;if(f.typeName==g.typeName&&f.direction!=g.direction||"Node"==f.typeName&&!VVVV.PinTypes[g.typeName].primitive||"Node"==g.typeName&&
